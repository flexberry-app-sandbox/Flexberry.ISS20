...
namespace IIS.ISS20
{
    ...
    public class ВидПоддержки : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.ISS20.Форма fФорма;
        
        private IIS.ISS20.DetailArrayOfУсловие fУсловие;
        ...
        [NotNull()]
        public virtual IIS.ISS20.Форма Форма
        {
            get
            {
                ...
                IIS.ISS20.Форма result = this.fФорма;
        ...
        public virtual IIS.ISS20.DetailArrayOfУсловие Условие
        {
            get
            {
                ...
                {
                    this.fУсловие = new IIS.ISS20.DetailArrayOfУсловие(this);
                }
                IIS.ISS20.DetailArrayOfУсловие result = this.fУсловие;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ВидПоддержкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВидПоддержкиE", typeof(IIS.ISS20.ВидПоддержки));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ВидПоддержкиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ВидПоддержкиL", typeof(IIS.ISS20.ВидПоддержки));
                }
            }
        }
    }
